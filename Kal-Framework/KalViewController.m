...
/*
 constructor created by Keith Lazuka, but it is not executed
 */
...
/*
 was created to get the wanted output of the calendar view
 as the actual constructor is not executed
 */
- (void)awakeFromNib {
